...
urlpatterns = [
    ...
    url(r'^book/del/(?P<book_id>\d+)/$', views.book_delete, name='book_del'),   # 削除
    ...
    url(r'^impression/del/(?P<book_id>\d+)/(?P<impression_id>\d+)/$', views.impression_delete, name='impression_del'),  # 削除
]